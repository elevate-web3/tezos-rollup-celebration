...
(let [background-color "#B9C2CF"
      main-js-name (if-let [asset-file (io/resource "public/cljs/assets.edn")]
                     ...
                     "main.js")]
  (defn home-page [_req]
    (-> [:html.h-100 {:style (str "background-color:" background-color ";")}
         [:head
          [:meta {:charset "utf-8"}]
         ...
         [:body {:style (str "background-color:" background-color ";")}
          [:div.d-flex.justify-content-center.align-items-center.position-relative {:style "height:100px;"}
           [:img.position-absolute {:style "width:200px;top:10px;left:10px"
